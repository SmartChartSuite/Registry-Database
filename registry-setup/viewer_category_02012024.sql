...
INSERT INTO viewer.category (concept_id,"section",category,question) VALUES
	 ...
	 (2000000166,'Treatment','Primary Treatment','Sickle Cell Disease Treatment'),
	 (2000000167,'Diagnoses','Primary Diagnoses','First Sickle Cell Encounter'),
	 (2000000168,'Diagnoses','Primary Diagnoses','Last Sickle Cell Encounter'),
	 (2000000169,'SCD Medication','Medication','Adakveo'),
	 (2000000170,'SCD Medication','Medication','Oxbrtya'),
	 (2000000171,'SCD Medication','Medication','Voxeletor'),
	 (2000000172,'SCD Medication','Medication','Hydroxyurea');
INSERT INTO viewer.category (concept_id,"section",category,question) VALUES
	 (2000000173,'SCD Medication','Medication','Endari'),
	 (2000000174,'SCD Medication','Medication','Deferasirox'),
	 (2000000175,'Other Medical History','Transfusion','Date of most recent transfusion of blood product'),
	 (2000000176,'Other Medical History','Medication','Medication'),
	 (2000000177,'Demographics','','Primary Care Provider Name'),
	 (2000000178,'Diagnoses','Primary Diagnoses','Sickle Cell Diagnosis');
